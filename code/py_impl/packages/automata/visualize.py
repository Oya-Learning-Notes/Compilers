...
class FADiGraph[LabelType]:
    _graphviz_obj: gv.Digraph = None
    get_node_label: Callable[[FANodeID, FANode[LabelType]], str]
    get_edge_label: Callable[[tuple[object, FANodeID]], str]

    def __init__(self):
        self.get_node_label = self.get_node_label_default
        self.get_edge_label = self.get_edge_label_default

    @staticmethod
    def get_node_label_default(nid: FANodeID, node: FANode[LabelType]) -> str:
        """
